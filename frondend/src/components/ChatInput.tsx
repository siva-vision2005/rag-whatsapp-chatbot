...
export default function ChatInput({ onSend }: Props) {
  ...
  return (
    <div className="bg-[#202c33] px-3 sm:px-4 pt-2.5 sm:pt-3 pb-[max(0.625rem,env(safe-area-inset-bottom))] flex items-center gap-2 sm:gap-3 border-t border-[#222e35]/30 shrink-0 sticky bottom-0 z-10">
